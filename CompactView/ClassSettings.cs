...
namespace CompactView
{
    public class Settings
    {
        ...
        public void Load()
        {
            ...
            if (table.Columns.Contains("ExecuteWithoutPrompt")) ExecuteWithoutPrompt = row.Field<bool>("ExecuteWithoutPrompt");
        ...
        public void Save()
        {
            ...
            table.Columns.Add("ExecuteWithoutPrompt", typeof(bool));
            ...
            row[8] = BackColor2;
            row[9] = ColorSet;
            row[10] = ExecuteWithoutPrompt;
            for (int i = 0; i < RecentFiles.Count; i++) row[i + 11] = RecentFiles[i];
            table.Rows.Add(row);
